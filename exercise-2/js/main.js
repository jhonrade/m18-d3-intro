...
$(function() {
  ...
  entering.append('p')
      .merge(paragraphs)
      .text(function(d) {return d.name}).style('font-size', '100px').style("font-weight", "bold")
  ...
  setTimeout(function(){
    ...
    paragraphs.exit()
        .transition().style('opacity', 0).duration(1000).style('color', 'yellow').delay(400)
        .remove();
  }, 3000);
});
